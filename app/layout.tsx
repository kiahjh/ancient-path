  ...
  return (
    <html lang="TODO">
      <body
        ...
        className={cx(`flex min-h-screen bg-cover bg-center`, roboto)}
      >
          ...
          <div>
            ...
            >
              <button
                ...
                className={cx(
                  `flex justify-between items-center h-12 transition-[background-color,padding] duration-300 hover:bg-sky-300/20 rounded-2xl`,
                  settingsPanelOpen ? `px-4` : `px-6`,
                )}
              >
        ...
        <div className="flex flex-col min-h-screen flex-grow">
          <main className="flex-grow rounded-bl-3xl bg-sky-50 p-20">
            {children}
          </main>
          <div className="h-24 flex items-center justify-end pr-8 gap-8">
            <Link
              href="/about"
