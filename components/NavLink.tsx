...
const NavLink: React.FC<Props> = ({
  ...
  return (
    <Link
      href={href}
      className={cx(
        `flex items-center gap-4 hover:bg-sky-200/70 active:bg-sky-300/50 dark:hover:bg-sky-500/5 dark:active:bg-sky-500/10 active:scale-[98%] transition-[background-color,transform] duration-200 px-4 sm:px-6 py-3 sm:py-4 rounded-3xl`,
