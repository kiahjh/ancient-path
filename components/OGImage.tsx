  ...
  return (
    <div className="bg-gradient-to-r from-white to-slate-100 w-[1200px] h-[630px] border border-white relative overflow-hidden flex flex-col">
      ...
      <h1 className="font-inter text-8xl p-16 relative leading-[105px]">
        <span className="text-slate-700">La Senda</span>
        <br />
        <span className="text-sky-500">Antigua</span>
      </h1>
      ...
      <Image
        src={ProfileImg}
        alt={'Jason R. Henderson'}
        className="w-96 h-128 object-cover rounded-tl-[80px] absolute right-0 bottom-0"
      />
      <span className="absolute bottom-8 right-[424px] text-3xl font-bold text-slate-700">
        Jason R. Henderson
      </span>
    </div>
  );
