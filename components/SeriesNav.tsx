...
function orderFromSlug(slug: string): number {
  switch (slug) {
    ...
    case `el-evangelio`:
      return 0;
    case `familiarity-with-the-spirit`:
    case `familiaridad-con-el-espiritu`:
      return 1;
    case `walk-in-the-spirit`:
    case `andar-en-el-espiritu`:
      return 2;
    case `law-and-grace`:
    case `la-ley-y-la-gracia`:
      return 3;
    case `the-way`:
    case `el-camino`:
      return 4;
    case `the-kingdom-of-god`:
    case `el-reino-de-dios`:
      return 5;
    case `the-new-covenant`:
    case `el-nuevo-pacto`:
      return 6;
    default:
      return 1000;
